...
- `test_command_not_on_allowlist_fails_profile_load` — mcp_servers[].command absent from EASYAGENT_MCP_ALLOWED_COMMANDS → profile load error, no subprocess spawned.
