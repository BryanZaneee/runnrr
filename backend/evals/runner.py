...
The implementation is split across sibling modules — backend.evals.retrieval
(per-variant retrieval + retrieval records), backend.evals.e2e (full-turn runs +
answer grading), and backend.evals.records (record/summary construction +
...
from backend.evals.datasets import RagDataset
from backend.evals.e2e import VARIANT_TOOLS, end_to_end_record
from backend.evals.records import RunResult, finalize
from backend.evals.retrieval import EvalCaseSkipped, retrieval_record
