...
constructed, so core Runnrr imports stay lightweight.
"""
        ...
        *,
        ...
        if not self._api_key:
            raise EmbeddingProviderError(
                "VOYAGE_API_KEY is required when RUNNRR_EMBEDDING_BACKEND=voyage"
            )
        try:
            import voyageai
    ...
    def _model(self):
        ...
        try:
            ...
            raise EmbeddingProviderError(
                ...
                'Install it with `pip install "runnrr[rag-local]"`.'
            ) from exc
