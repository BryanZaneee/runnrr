...
from runnrr.config import PROFILE_ROOT
from runnrr.evals.datasets import load_rag_dataset
from runnrr.evals.records import recall_metric
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="python -m runnrr.evals.cli")
    parser.add_argument(
        "--profile-root",
        type=Path,
        default=None,
